...
public class CEducacion {
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id){
        ...
        return new ResponseEntity(new Mensaje("Esta educación fue eliminada exitosamente"), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        return new ResponseEntity(new Mensaje("Educaión actualizada"), HttpStatus.OK);
    }
}
