...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){
        ...
        if(sExperiencia.existsByNombreE(dtoexp.getNombreE()))
            ...
            return new ResponseEntity(new Mensaje("La experiencia fue agregada satisfactoriamente"), HttpStatus.OK);        
    } 
    
    @PutMapping("/update/{id}")
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        //Vlido si exite el ID
        ...
        //Comprobar si el campo nombre está en blanco o vacio
        if(StringUtils.isBlank(dtoexp.getNombreE()))
            return new ResponseEntity(new Mensaje("El nombre es obligatorio"), HttpStatus.BAD_REQUEST);
        ...
        sExperiencia.save(experiencia);
        return new ResponseEntity(new Mensaje("Esta experiencia fue actualizada"), HttpStatus.OK);
    }
